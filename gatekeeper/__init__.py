...
def gatekeep(*args: Any, **kwargs: Any) -> Any:
    from gatekeeper.gatekeeper import gatekeep as _gatekeep

    return _gatekeep(*args, **kwargs)


def is_unsafe_user_input(*args: Any, **kwargs: Any) -> Any:
    from gatekeeper.gatekeeper import is_unsafe_user_input as _is_unsafe_user_input
...
def __getattr__(name: str) -> Any:
    if name in {"GatekeeperResult", "TimeRange"}:
        from gatekeeper.schemas import GatekeeperResult, TimeRange
